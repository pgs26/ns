...
def visualize_graph(G, title="Graph Visualization", max_nodes=100):
    ...
    # Draw graph - FIXED VERSION
    nx.draw_networkx_nodes(G, pos, node_size=max(10, 200/np.sqrt(G.number_of_nodes())), 
...
def main():
    ...
    graph_file = "D:\\PSG\\sem9\\NS\\graph.gml"  # Change this to your file
